...
public class TaskUI
{
    ...
    public TaskUI(Task task,Vector3 position, Quaternion rotation, Vector2 size, UISettings settings) {
    ...
    public TaskUI(Task task, Vector3 position, Quaternion rotation, Vector2 size) {
    ...
    private void Create()
    {
        ResourceUIObj = new GameObject(_task.Id.ToString())
        {
            layer = 5
        };
        ...
        var layout = new TaskUILayout(ResourceUIObj, _settings);
