...
namespace Assets.Scripts.UI.TaskUI
{
    internal class TaskUILayout
    {
        ...
        public GameObject InfoHeaderObj;
        public GameObject InfoHeaderTextObj;
        public GameObject InfoScrollViewObj;
        public GameObject InfoViewPortObj;
        public GameObject InfoSlidingAreaObj;
        public GameObject InfoHandleObj;
        public GameObject InfoContenObj;
        public GameObject InfoScrollbarVerticalObj;

        public GameObject AssignedResourcesObj;
        public GameObject AssignedResourcesHeaderObj;
        public GameObject AssignedResourcesHeaderTextObj;
        public GameObject AssignedResourcesScrollViewObj;
        public GameObject AssignedResourcesViewPortObj;
        public GameObject AssignedResourcesSlidingAreaObj;
        public GameObject AssignedResourcesHandleObj;
        public GameObject AssignedResourcesContenObj;
        public GameObject AssignedResourcesScrollbarVerticalObj;

        public GameObject AssignedDataObj;
        public GameObject AssignedDataHeaderObj;
        public GameObject AssignedDataHeaderTextObj;
        public GameObject AssignedDataScrollViewObj;
        public GameObject AssignedDataViewPortObj;
        public GameObject AssignedDataSlidingAreaObj;
        public GameObject AssignedDataHandleObj;
        public GameObject AssignedDataContenObj;
        public GameObject AssignedDataScrollbarVerticalObj;

        public TaskUILayout(GameObject taskUIObj, UISettings settings) {
        ...
        private void Layout()
        {
            ...
            var layoutGroup = TaskUIObj.AddComponent<VerticalLayoutGroup>();
        ...
        private void TitleBar()
        {
           TitleBarObj = new GameObject("TitleBar")
            ...
            transform.SetParent(TaskUIObj.transform);
        ...
        private void TopPanel()
        {
            ...
            InfoObj = Panel(TopPanelObj.transform, "PersonalInfo");
            InfoHeaderObj = Header(InfoObj.transform);
            InfoHeaderTextObj = HeaderText(InfoHeaderObj.transform);

            InfoScrollViewObj = ScrollView(InfoObj.transform);
            InfoViewPortObj = Viewport(InfoScrollViewObj.transform);
            InfoScrollbarVerticalObj = ScrollbarVertical(InfoScrollViewObj.transform);
            InfoSlidingAreaObj = SlidingArea(InfoScrollbarVerticalObj.transform);
            InfoHandleObj = Handle(InfoSlidingAreaObj.transform);
            InfoContenObj = Content(InfoViewPortObj.transform);

            AddScrollBar(InfoScrollbarVerticalObj);
            AddScrollRect(InfoScrollViewObj);
        }
        ...
        private void BottomPanel()
        {
            ...
            AssignedResourcesHeaderTextObj = HeaderText(AssignedResourcesHeaderObj.transform);
            AssignedResourcesScrollViewObj = ScrollView(AssignedResourcesObj.transform);
            AssignedResourcesViewPortObj = Viewport(AssignedResourcesScrollViewObj.transform);
            AssignedResourcesScrollbarVerticalObj = ScrollbarVertical(AssignedResourcesScrollViewObj.transform);
            AssignedResourcesSlidingAreaObj = SlidingArea(AssignedResourcesScrollbarVerticalObj.transform);
            AssignedResourcesHandleObj = Handle(AssignedResourcesSlidingAreaObj.transform);
            AssignedResourcesContenObj = Content(AssignedResourcesViewPortObj.transform);
            AddScrollBar(AssignedResourcesScrollbarVerticalObj);
            AddScrollRect(AssignedResourcesScrollViewObj);

            AssignedDataObj = Panel(BottomPanelObj.transform, "Skills");
            AssignedDataHeaderObj = Header(AssignedDataObj.transform);
            AssignedDataHeaderTextObj = HeaderText(AssignedDataHeaderObj.transform);
            AssignedDataScrollViewObj = ScrollView(AssignedDataObj.transform);
            AssignedDataViewPortObj = Viewport(AssignedDataScrollViewObj.transform);
            AssignedDataScrollbarVerticalObj = ScrollbarVertical(AssignedDataScrollViewObj.transform);
            AssignedDataSlidingAreaObj = SlidingArea(AssignedDataScrollbarVerticalObj.transform);
            AssignedDataHandleObj = Handle(AssignedDataSlidingAreaObj.transform);
            AssignedDataContenObj = Content(AssignedDataViewPortObj.transform);
            AddScrollBar(AssignedDataScrollbarVerticalObj);
            AddScrollRect(AssignedDataScrollViewObj);
        }
