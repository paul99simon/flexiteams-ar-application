...
namespace Assets.Scripts.UI.ResourceUI
{
    internal class ResourceUIStyle
    {
        ...
        private void HeaderStyle(GameObject header)
        {
            ...
            image.sprite = _settings.ResourceUISettings.HeaderSettings.BackgroundSprite;
            image.color = _settings.ResourceUISettings.HeaderSettings.BackgroundColor;
            image.type = Image.Type.Sliced;
        }
        ...
        private void HeaderTextStyle(GameObject headerText)
        {
            ...
            tmp.font = _settings.TMP_FontAsset;
            tmp.fontStyle = _settings.ResourceUISettings.HeaderSettings.FontStyles;
            tmp.fontSize = _settings.ResourceUISettings.HeaderSettings.FontSize;
            tmp.verticalAlignment = VerticalAlignmentOptions.Middle;
            tmp.horizontalAlignment = HorizontalAlignmentOptions.Center;
            tmp.enableWordWrapping = false;
            tmp.color = _settings.ResourceUISettings.HeaderSettings.TextColor;
        }
